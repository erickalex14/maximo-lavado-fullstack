...
class VentaProductoDespensaService
{
    protected $ventaRepository;

    public function __construct(VentaProductoDespensaRepositoryInterface $ventaRepository)
    {
    ...
    public function findVentaById(int $id): ?VentaProductoDespensa
    {
    ...
    public function updateVenta(int $id, array $data): ?VentaProductoDespensa
    {
