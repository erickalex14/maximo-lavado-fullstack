      ...
      <tbody class="bg-white divide-y divide-gray-200">
        <tr v-if="loading" class="animate-pulse">
          <td colspan="6" class="px-6 py-4 text-center text-gray-500">
            Cargando productos de despensa...
          </td>
        </tr>
        <tr v-else-if="!productos.length">
          <td colspan="6" class="px-6 py-4 text-center text-gray-500">
            No se encontraron productos de despensa
          </td>
        </tr>
        <tr 
          v-else
          v-for="producto in productos" 
          :key="producto.producto_despensa_id"
...
import type { ProductoDespensa } from '@/types';
...
const emit = defineEmits<{
  view: [producto: ProductoDespensa];
  edit: [producto: ProductoDespensa];
  delete: [producto: ProductoDespensa];
