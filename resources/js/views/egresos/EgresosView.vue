  ...
  <div class="p-6">
    ...
    <div class="bg-white rounded-lg shadow-sm p-8 text-center">
      <div class="max-w-md mx-auto">
        ...
        <h3 class="text-lg font-medium text-gray-900 mb-2">Vista de Egresos en Desarrollo</h3>
        <p class="text-gray-500 mb-4">
          Esta sección estará disponible próximamente. Aquí podrás gestionar todos los egresos.
        </p>
